...
Across 36 measured chains, plain Metropolis produced the highest measured mean plaquette ESS/s at all three tested couplings. For the scalar observable, plain Metropolis was the most efficient tested schedule at beta = 1.5 and beta = 2.0. At beta = 2.5, one overrelaxation sweep per Metropolis sweep was the most efficient tested scalar schedule. Its measured mean ESS/s ratio to the paired Metropolis baseline was [[SCALAR_RATIO]], an approximately [[SCALAR_IMPROVEMENT]]% advantage.
...
Across the 36 final campaign records, the mean measured Metropolis acceptance rate was [[MEAN_ACCEPTANCE]].
...
[[CAMPAIGN_RUNTIME]] seconds.

The active Python version was `[[PYTHON_VERSION]]`.

The active NumPy version was `[[NUMPY_VERSION]]`.
...
The clean release efficiency ratio was [[SCALAR_RATIO]], corresponding to an approximately [[SCALAR_IMPROVEMENT]]% measured advantage over the paired Metropolis baseline.
